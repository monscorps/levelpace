...
h.run("IsPlayerGUID distinguishes players from everything else", function()
  local LP = load()
  h.eq(LP.util.IsPlayerGUID("0x0000000000ABCDEF"), true, "player")
  h.eq(LP.util.IsPlayerGUID("0xF13000020D02DD76"), false, "creature")
  h.eq(LP.util.IsPlayerGUID("0xF140000C6D000001"), false, "pet")
  h.eq(LP.util.IsPlayerGUID("0xF150000C6D000001"), false, "vehicle")
  h.eq(LP.util.IsPlayerGUID(nil), false, "nil")
  h.eq(LP.util.IsPlayerGUID("0x0000"), false, "too short")
end)
